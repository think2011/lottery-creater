...
export default class {
    constructor({startValue, endValue, startSpeed, loopSpeed, endSpeed, startEasing, loopEasing, endEasing, minTime}) {
    ...
    _checkStop({isLoop, value}) {
        ...
        this.loopTween.stop()
        new TWEEN.Tween({value: this.startValue, isLoop: true})
            .to({value: this.stopValue}, this.endSpeed)
