module.exports = {
    ...
    "modules": [{
        ...
        "children": [{
            ...
            "data" : {"src": "//img.alicdn.com/imgextra/i2/92779311/TB2wfiiXCxjpuFjSszeXXaeMVXa-92779311.png"}
        }, {
            "type" : "pointer",
            "alias": "指针(抽奖按钮)",
            "style": {"width": "248px", "height": "248px", "top": "420px", "left": "251px"},
            "data" : {"src": "//img.alicdn.com/imgextra/i4/92779311/TB2l28iXS4mpuFjSZFOXXaUqpXa-92779311.png"}
        }],
        "data"    : {
            "rotateType" : "bg",
        ...
        "children": [{
            "type" : "shopping",
            "alias": "加购",
            "style": {"width": "124px", "height": "48px", "top": "890px", "left": "110px"},
            "data" : {}
        }, {
            "type" : "collect",
            "alias": "收藏",
            "style": {"width": "124px", "height": "48px", "top": "890px", "left": "246px"},
            "data" : {}
        }, {
            "type" : "share",
            "alias": "分享",
            "style": {"width": "124px", "height": "48px", "top": "890px", "left": "380px"},
            "data" : {}
        }, {
            "type" : "order",
            "alias": "下单",
            "style": {"width": "124px", "height": "48px", "top": "890px", "left": "516px"},
            "data" : {}
        }]
    }, {
        "type" : "luckyList",
        "alias": "中奖名单",
        "style": {"width": "400px", "height": "30px", "top": "967px", "left": "246px"},
        "data" : {"type": 1, "textStyle": {"fontSize": "16px", "color": "#fff"}}
    }, {
        "type" : "rule",
        "alias": "游戏规则",
